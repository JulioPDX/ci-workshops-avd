...
| --------- | --------------- | ------------ | --------- |
| IDF1 | Vlan4094 | 10.253.1.0 | Port-Channel47 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49 | P2P_spine-2_Ethernet3 | - | 172.16.1.3/31 | default | 1500 | False | - | - |
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.255.3/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 10.250.1.4:10110 | 10110:10110 | - | - | learned |
| 120 | 10.250.1.4:10120 | 10120:10120 | - | - | learned |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf-1a
   ...
   neighbor 10.252.1.0 description leaf-1a_Vlan4093
   neighbor 172.16.1.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.2 remote-as 65100
   neighbor 172.16.1.2 description spine-2_Ethernet3
   ...
   vrf OVERLAY
      ...
      update wait-install
      neighbor 10.252.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.0 description leaf-1a_Vlan3009
