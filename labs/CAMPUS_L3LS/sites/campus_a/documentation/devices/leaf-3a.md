...
| --------- | --------------- | ------------ | --------- |
| IDF3 | Vlan4094 | 10.253.1.1 | Port-Channel47 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet47 | MLAG_leaf-3b_Ethernet47 | *trunk | *- | *- | *MLAG | 47 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49 | P2P_spine-1_Ethernet5 | - | 172.16.1.13/31 | default | 1500 | False | - | - |
| Ethernet50 | P2P_spine-2_Ethernet5 | - | 172.16.1.15/31 | default | 1500 | False | - | - |
...
interface Ethernet47
   description MLAG_leaf-3b_Ethernet47
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description MLAG_leaf-3b_Ethernet48
   no shutdown
   channel-group 47 mode active
!
interface Ethernet49
   description P2P_spine-1_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50
   description P2P_spine-2_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet51
   description L2_member-leaf-3c_Ethernet49
   no shutdown
...
interface Port-Channel47
   description MLAG_leaf-3b_Port-Channel47
   no shutdown
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.250.1.6:10100 | 10100:10100 | - | - | learned |
| 310 | 10.250.1.6:10310 | 10310:10310 | - | - | learned |
| 320 | 10.250.1.6:10320 | 10320:10320 | - | - | learned |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description leaf-3b
   ...
   vrf OVERLAY
      ...
      update wait-install
      neighbor 10.252.1.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.1 description leaf-3b_Vlan3009
