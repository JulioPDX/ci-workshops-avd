...
| --------- | --------------- | ------------ | --------- |
| IDF3 | Vlan4094 | 10.253.1.0 | Port-Channel47 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet47 | MLAG_leaf-3a_Ethernet47 | *trunk | *- | *- | *MLAG | 47 |
| Ethernet48 | MLAG_leaf-3a_Ethernet48 | *trunk | *- | *- | *MLAG | 47 |
| Ethernet51 | L2_member-leaf-3c_Ethernet50 | *trunk | *310,320 | *- | *- | 51 |
| Ethernet52 | L2_member-leaf-3d_Ethernet50 | *trunk | *310,320 | *- | *- | 52 |
| Ethernet53/1 | L2_member-leaf-3e_Ethernet50 | *trunk | *100,310,320 | *- | *- | 531 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49 | P2P_spine-1_Ethernet6 | - | 172.16.1.17/31 | default | 1500 | False | - | - |
| Ethernet50 | P2P_spine-2_Ethernet6 | - | 172.16.1.19/31 | default | 1500 | False | - | - |
...
interface Ethernet47
   description MLAG_leaf-3a_Ethernet47
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description MLAG_leaf-3a_Ethernet48
   no shutdown
   channel-group 47 mode active
!
interface Ethernet49
   description P2P_spine-1_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50
   description P2P_spine-2_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet51
   description L2_member-leaf-3c_Ethernet50
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description L2_member-leaf-3d_Ethernet50
   no shutdown
   channel-group 52 mode active
!
interface Ethernet53/1
   description L2_member-leaf-3e_Ethernet50
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel47 | MLAG_leaf-3a_Port-Channel47 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel47
   description MLAG_leaf-3a_Port-Channel47
   no shutdown
...
interface Port-Channel51
   description L2_member-leaf-3c_Port-Channel49
   no shutdown
...
interface Port-Channel52
   description L2_member-leaf-3d_Port-Channel49
   no shutdown
   switchport trunk allowed vlan 310,320
   switchport mode trunk
   switchport
...
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.255.6/32 |
...
| --------- | ----------- | --- | --- | -------- |
| Vlan100 | GENERAL_DATA | OVERLAY | - | False |
| Vlan310 | IDF3_DATA | OVERLAY | - | False |
| Vlan320 | IDF3_VOICE | OVERLAY | - | False |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan100 | OVERLAY | - | 10.100.100.1/24 | - | - | - |
| Vlan310 | OVERLAY | - | 10.3.10.1/24 | - | - | - |
| Vlan320 | OVERLAY | - | 10.3.20.1/24 | - | - | - |
...
!
interface Vlan100
   description GENERAL_DATA
   no shutdown
   vrf OVERLAY
   ip address virtual 10.100.100.1/24
!
interface Vlan310
   description IDF3_DATA
   no shutdown
   vrf OVERLAY
   ip address virtual 10.3.10.1/24
!
interface Vlan320
   description IDF3_VOICE
   no shutdown
   vrf OVERLAY
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.250.1.7:10100 | 10100:10100 | - | - | learned |
| 310 | 10.250.1.7:10310 | 10310:10310 | - | - | learned |
| 320 | 10.250.1.7:10320 | 10320:10320 | - | - | learned |
...
router bgp 65103
   ...
   vrf OVERLAY
      ...
      update wait-install
      neighbor 10.252.1.0 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.252.1.0 description leaf-3a_Vlan3009
